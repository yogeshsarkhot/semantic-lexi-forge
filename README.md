...
…all built with modern, production-ready tools: React + Vite (frontend), Spring Boot 3 + PostgreSQL (backend), Docker + OpenShift-ready deployment, Terraform (AWS/Azure multi-cloud), and observability/logging foundations.
...
- Terraform IaC (AWS + Azure + OpenShift/ROSA)  
